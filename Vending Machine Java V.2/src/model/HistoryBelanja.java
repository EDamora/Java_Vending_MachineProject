...
public class HistoryBelanja {
    ...
    public HistoryBelanja() {}

    // Constructor lengkap
    public HistoryBelanja(int id, String namaBarang, int jumlah, double hargaTotal, LocalDateTime tanggal) {
        this.id = id;
    ...
    public HistoryBelanja(String namaBarang, int jumlah, double hargaTotal, LocalDateTime tanggal) {
        this.namaBarang = namaBarang;
        this.jumlah = jumlah;
        this.hargaTotal = hargaTotal;
        this.tanggal = tanggal;
